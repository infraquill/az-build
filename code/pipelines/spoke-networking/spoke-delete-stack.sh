#!/usr/bin/env bash
#
# spoke-delete-stack.sh
# Location: code/pipelines/spoke-networking/
#
# Deletes the spoke networking deployment stack at subscription scope.
...
echo "=============================================="
echo "Deleting Spoke Networking Deployment Stack"
echo "=============================================="
